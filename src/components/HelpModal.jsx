        ...
        <div className="modal-body" style={{ maxHeight: '60vh', overflowY: 'auto' }}>
          {activeTab === 'usecases' && (
            <div className="help-section">
              ...
              <div className="use-case-card mb-4 p-4" style={{ background: 'rgba(255,255,255,0.02)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-color)' }}>
              ...
              <div className="use-case-card p-4" style={{ background: 'rgba(255,255,255,0.02)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-color)' }}>
            ...
            <div className="help-section">
              ...
              <ul className="math-list" style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                <li>
                  ...
                  <code style={{ background: 'rgba(0,0,0,0.3)', padding: '0.25rem 0.5rem', borderRadius: '4px', display: 'inline-block', margin: '0.5rem 0', color: 'var(--text-primary)' }}>
          ...
          {activeTab === 'results' && (
            <div className="help-section">
              ...
              <div className="result-card mb-4 p-4" style={{ background: 'rgba(16, 185, 129, 0.05)', borderRadius: 'var(--radius-md)', borderLeft: '4px solid var(--accent-success)' }}>
              ...
              <div className="result-card mb-4 p-4" style={{ background: 'rgba(59, 130, 246, 0.05)', borderRadius: 'var(--radius-md)', borderLeft: '4px solid var(--accent-secondary)' }}>
              ...
              <div className="result-card mb-4 p-4" style={{ background: 'rgba(139, 92, 246, 0.05)', borderRadius: 'var(--radius-md)', borderLeft: '4px solid var(--accent-primary)' }}>
              ...
              <div className="result-card p-4" style={{ background: 'rgba(255, 255, 255, 0.02)', borderRadius: 'var(--radius-md)', borderLeft: '4px solid var(--text-muted)' }}>
